...
{
    public class Dim10DoubleNumpyWrapper : INumpyArrayWrapper<double>
    {
        ...
        public Dim10DoubleNumpyWrapper(double[,,,,,,,,,] array)
        {
            ...
            this.shape = new[]
            {
                ...
                array.GetLength(5), array.GetLength(6), array.GetLength(7), array.GetLength(8), array.GetLength(9)
            };
        }
        ...
        {
            double[,,,,,,,,,] result = new double[shape[9], shape[8], shape[7], shape[6], shape[5], shape[4], shape[3],
