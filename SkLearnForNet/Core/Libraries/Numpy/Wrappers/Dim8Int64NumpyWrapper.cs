...
{
    public class Dim8Int64NumpyWrapper : INumpyArrayWrapper<long>
    {
        private long[,,,,,,,] array;
        private int[] shape;
        ...
        public Dim8Int64NumpyWrapper(long[,,,,,,,] array)
        {
            ...
            this.shape = new[]
            {
                ...
                array.GetLength(5), array.GetLength(6), array.GetLength(7)
            };
        }
        ...
        {
            long[,,,,,,,] result = new long[shape[7], shape[6], shape[5], shape[4], shape[3], shape[2], shape[1],
                shape[0]];
