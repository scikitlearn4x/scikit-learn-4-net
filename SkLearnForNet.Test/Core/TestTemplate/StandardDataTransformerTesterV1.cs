...
{
    public class StandardDataTransformerTesterV1 : BaseTesterV1
    {
        ...
        protected override void PerformUseCaseSpecificTest(IScikitLearnPackage binaryPackage)
        {
            ...
            NumpyArray<double> encoderInverseTransformOutput = transformerMixin.InverseTransform(transformed);
